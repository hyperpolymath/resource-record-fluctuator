...
// Replace resource-record-fluctuator, Resource Record Fluctuator — See README.adoc for details., just run, Resource Record Fluctuator started successfully. with actuals
= resource-record-fluctuator — Quick Start for Users
:toc:
:toclevels: 2

== What is resource-record-fluctuator?

Resource Record Fluctuator — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./resource-record-fluctuator-portable
----
...
[source]
----
Resource Record Fluctuator started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/resource-record-fluctuator/wiki
