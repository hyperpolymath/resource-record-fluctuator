{
  description = "resource-record-fluctuator - {project-description}";
    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in
      {
        ...
        devShells.default = pkgs.mkShell {
          ...
          shellHook = ''
            echo "🚀 resource-record-fluctuator development environment"
            echo "Language: mixed"
            echo ""
        ...
        packages.default = pkgs.stdenv.mkDerivation {
          ...
          buildPhase = ''
            ...
            # For Ada: gprbuild -P resource-record-fluctuator.gpr -XMODE=release
          '';

          installPhase = ''
            mkdir -p $out/bin
            # *REMINDER: Add install commands*
            # cp target/release/resource-record-fluctuator $out/bin/  # Rust
            # cp bin/resource-record-fluctuator $out/bin/  # Ada
          '';
        ...
        apps.default = {
          type = "app";
          program = "${self.packages.${system}.default}/bin/resource-record-fluctuator";
        };
        ...
        checks = {
          ...
          test = pkgs.runCommand "test-resource-record-fluctuator" {
