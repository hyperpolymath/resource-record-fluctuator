...
doctor:
    @echo "Running diagnostics for resource-record-fluctuator..."
...
heal:
    @echo "Attempting auto-repair for resource-record-fluctuator..."
...
tour:
    @echo "=== resource-record-fluctuator Tour ==="
    @echo ""
...
help-me:
    @echo "=== resource-record-fluctuator Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/hyperpolymath/resource-record-fluctuator/issues/new"
    @echo ""
